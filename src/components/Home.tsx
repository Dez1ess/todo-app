...
export default function Home() {
  ...
  const fetchUserTasks = async () => {
    try {
      const taskResponse = await axios.get(`https://dave-todo-app-api.onrender.com/user/tasks/${userinfo.userId}`);
  ...
  const fetchUserData = async () => {
    try {
      const response = await axios.get("https://dave-todo-app-api.onrender.com/auth/user", {
  ...
  const handleLogout = async (e: React.FormEvent) => {
    ...
    try {
      await axios.post('https://dave-todo-app-api.onrender.com/auth/logout');
      navigate('/auth/login'); 
