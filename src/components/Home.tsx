...
export default function Home() {
  ...
  const fetchUserTasks = async () => {
    try {
      const taskResponse = await axios.get(`https://todo-app-pied-nine.vercel.app/user/tasks/${userinfo.userId}`);
  ...
  const fetchUserData = async () => {
    try {
      const response = await axios.get("https://todo-app-pied-nine.vercel.app/auth/user", {
  ...
  const handleLogout = async (e: React.FormEvent) => {
    ...
    try {
      await axios.post('https://todo-app-pied-nine.vercel.app/auth/logout');
      navigate('/auth/login'); 
