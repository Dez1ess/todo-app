...
export const addTaskAsync = createAsyncThunk(
  ...
  async (payload: AddTaskPayload) => {
    const response = await axios.post("https://todo-app-api-chi.vercel.app/user/tasks", {
      id: payload.id, 
      title: payload.title,
...
export const removeTaskAsync = createAsyncThunk(
  ...
  async (payload: RemoveTaskPayload) => {
    await axios.delete(`https://todo-app-api-chi.vercel.app/user/tasks/${payload.userId}/${payload.id}`);
    return payload.id;
  }
);
...
export const completeTaskAsync = createAsyncThunk(
  ...
  async (payload: CompleteTaskPayload) => {
    await axios.put(`https://todo-app-api-chi.vercel.app/user/tasks/${payload.userId}/${payload.id}`);
    return payload.id;
  }
);
